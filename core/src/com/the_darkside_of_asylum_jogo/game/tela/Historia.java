...
public class Historia implements Screen{
		...
		public Historia (The_DarkSide_of_Asylum_Jogo jogo) {
			...
			this.fundo_escolhas = new Texture(Gdx.files.internal("Imagens/Cenarios/london.png"));
			this.historia_personagem = new Texture(Gdx.files.internal("Imagens/Textos/historia_harry.png"));
		...
		@Override
		public void show() {
			narracao.tocar("Musica/FINALMENTE.mp3", false);
			narracao.start();
		}
