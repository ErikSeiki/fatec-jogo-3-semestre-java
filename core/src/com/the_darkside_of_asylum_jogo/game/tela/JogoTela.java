...
public class JogoTela implements Screen {
	...
	public JogoTela(The_DarkSide_of_Asylum_Jogo jogoP) {
		...
		this.medico = new NPC(this, "Imagens/Interativos/Medico.png","Medico", 17, 26, Gdx.graphics.getWidth(), 250);
		...
		this.porta = new Objetos(this, "Imagens/Interativos/Porta.png", 70, 116, 310, (70 - 50 /2));

		this.enfermeiro = new NPC(this, "Imagens/Interativos/Enfermeiro.png","Enfermeiro", 17, 26, Gdx.graphics.getWidth(),250);
		this.threadEnfermeiro = new Thread(enfermeiro);

		this.cafe = new Objetos(this, "Imagens/Interativos/Cafe.png", 65, 78, 247, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65/2));

		this.guarda = new NPC(this, "Imagens/Interativos/Guarda.png","Guarda", 17, 26, Gdx.graphics.getWidth(),250);
		this.threadGuarda = new Thread(guarda);

		this.cigarro = new Objetos(this, "Imagens/Interativos/Cigarro.png", 65, 78, 247, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65/2));

		this.bebida = new Objetos(this, "Imagens/Interativos/Bebida.png", 65, 78, 247, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65 /2));

		this.parede = new Objetos(this, "Imagens/Interativos/Parede.png", 51, 78, 265, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 51 /2));

		this.cama = new Objetos(this, "Imagens/Interativos/Cama.png", 65, 78, 230, (900 - 65 /2));

		this.remedio = new Objetos(this, "Imagens/Interativos/Remedio.png", 65, 78, 247, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65 /2));

		this.estante = new Objetos(this, "Imagens/Interativos/Estante.png", 65, 78, 250, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65 /2));

		this.mesa = new Objetos(this, "Imagens/Interativos/Mesa.png", 65, 78, 250, (The_DarkSide_of_Asylum_Jogo.LARGURA_TELA / 2 - 65 /2));

		this.estante2 = new Objetos(this, "Imagens/Interativos/Estante2.png", 60,60, 230, (400 - 60 /2));

		this.armario = new Objetos(this, "Imagens/Interativos/Armario.png", 130, 150, 320,(140 - 130 /2));
		...
		this.mastigarSom.tocar("Musica/MASTIGAÇÃO.mp3", false);
		this.mastigarSom.setTocando("tocar");
		this.passosSom = new Som();
		this.passosSom.tocar("Musica/PASSOS.mp3", false);
		this.passosSom.setTocando("tocar");
		this.portaSom = new Som();
		this.portaSom.tocar("Musica/PORTA.mp3", false);
		this.portaSom.setTocando("tocar");
		this.gritoSom = new Som();
		this.gritoSom.tocar("Musica/SONS DE GRITO.mp3", false);
